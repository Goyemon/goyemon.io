...
const FAQS = [
  ...
  },
  {
    ...
    content: () => (
      <>
        As we build a product without charging anything to our customers, it is our challenge to grow without spending too much money on fancy marketing. Currently, all the transactions sent from Goyemon have the "Sent from Goyemon" signature to spread the words(as you can see in Etherscan). This costs only 0.00000408 which is about which is 0.00082 USD(as of May 16, 2020). 
      </>
    ),
  },  {
    title: 'What is a network fee?',
